...
%< @version     2.2.0
%< Make ramp timing programmable; TRampUp and Tp are used to select timing
%< Correct order of receive channels
...
classdef DemoRad<UsbAdi
    ...
    properties (Access = public)
        ...
        ADIFMCWCfg      = [ hex2dec('00000000'), ...
                            hex2dec('00000007'), ...
                            hex2dec('00001100'), ...
                            hex2dec('00000080'), ...            % Number Rows
                            hex2dec('00000100'), ...            % Number Cols
                            hex2dec('00000004'), ...            % Number of channels  
                            hex2dec('00000008'), ...            % Samples after Ramp
                            hex2dec('00000024'), ...            % Samples before ramp
                            hex2dec('00000001'), ...            % Clock select 1 = 1, 2 = 1.2, 3 = 1.8
                            hex2dec('0000000A') ];
...
%             obj.CmdRecv();
        ...
        function    Ret     =   Dsp_SetMimo(obj, Val)
            %   @function       Dsp_Strt
            %   @author         Philipp Wagner
            %   @date           07.12.2016
            %   @brief          Start application
